...
def moderate_custom(custom_text, difficulty):
    ...
    try:
        ...
        if any(w in text_lower for w in ["conspiracy", "they don't want you", "fake news", "hoax"]):
...
👉 [Open Swagger UI](https://amikumarsingh-ai-content-compliance-openenv.hf.space/docs)

👉 [Open ReDoc](https://amikumarsingh-ai-content-compliance-openenv.hf.space/redoc)
